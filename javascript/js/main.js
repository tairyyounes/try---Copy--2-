  ...
  const translations = {
    en: {
      ...
      products: {
        ...
        cardsData: {
          ...
          'card-family-8': { title: 'RIO Family Croissant', desc: 'Croissant family pack containing 8 pieces. Weight 65g.', info: '8 Pieces | 1 Month Validity | Family Pack', tag: 'Family - 8 Pcs' },
    ...
    ar: {
      ...
      products: {
        ...
        tabs: ['كرواسون ريو', 'ريو فاميلي', 'كيك ريو', 'توست ريو'],
        cardsData: {
          ...
          'card-family-8': { title: 'كرواسون عائلي — Rio Family', desc: 'كرواسون عبوة عائلية تحتوي على 8 قطع. وزن القطعة 65 جرام.', info: '8 قطع | صلاحية شهر واحد | Family Pack', tag: 'عائلي - 8 قطع' },
